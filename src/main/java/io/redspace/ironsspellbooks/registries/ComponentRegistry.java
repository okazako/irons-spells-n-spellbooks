...
public class ComponentRegistry {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Holder<UpgradeOrbType>>> UPGRADE_ORB_TYPE = register("upgrade_orb_type", (builder) ->builder.persistent(UpgradeOrbTypeRegistry.UPGRADE_ORB_REGISTRY_CODEC).networkSynchronized(UpgradeOrbTypeRegistry.UPGRADE_ORB_REGISTRY_STREAM_CODEC).cacheEncoding());
}
